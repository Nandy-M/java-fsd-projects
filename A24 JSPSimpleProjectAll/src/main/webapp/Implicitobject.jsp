...
<%@ page errorPage = "ImplicitHandle-error.jsp" %>    
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<%
        ...
        if (responseCheck != null ) {
                 ...
                 response.setHeader("Location", "Implicitresponse-redirect.jsp?office=" + responseCheck);
        }
...
%>
<a href="Implicitobject.jsp?office=head_office">Show usage of response object</a><br>
<a href="Implicitobject.jsp?error=1">Show usage of error  object</a><br>
